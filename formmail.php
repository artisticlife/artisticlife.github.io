...
$TARGET_EMAIL = array("^jeremy@artisticlifephoto\.com$");

/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT = "jeremy@artisticlifephoto.com";

/* Help: http://www.tectite.com/fmdoc/site_domain.php */
$SITE_DOMAIN = "http://artisticlifephoto.com/"; /* your website domain name */
...
$FROM_USER = "jeremy@artisticlifephoto.com"; /* the default - setting not used */
...
$TEMPLATEDIR = "/home/content/35/13967635/html"; /* directory for template files; empty string if you don't have any templates */

/* Help: http://www.tectite.com/fmdoc/templateurl.php */
$TEMPLATEURL = "http://www.artisticlifephoto.com/fmtemplates"; /* default; no template URL */
...
$MAXSTRING = 10000; /* maximum string length for a value */
...
function LoadBuiltinLanguage()
{
	...
	// Parameters: none
	$aMessages[MSG_THANKS_PAGE] = 'Thanks!  We\'ve received your application. ' .
	                              'You should now be redirected to the Release form.';
